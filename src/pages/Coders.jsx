...
// so the point is these needs to be changed general physician and all but can only be done once you have changed it in the backend majoryly admin portal
  return (
    <div>
